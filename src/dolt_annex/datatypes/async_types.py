...
class ContextManager[T](Protocol):
    ...
    def __exit__(self, exc_type: type[BaseException] | None, exc_val: BaseException | None, exc_tb: TracebackType | None, /) -> Any: ...
...
class ReadableStream(Closable, Protocol):
    ...
    def readinto(self, b: Buffer, /) -> Awaitable[int | None]:
        ...
